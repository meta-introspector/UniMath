 ...
 struct
  ...
  | Da d0 ->
    String ((Ascii (Coq_true, Coq_false, Coq_false, Coq_false, Coq_false,
      Coq_true, Coq_true, Coq_false)), (string_of_uint d0))
  | Db d0 ->
