 ...
 struct
  module type WFacts_funSig =
   ...
   sig
    ...
    val coq_In_dec : 'a1 M.t -> M.key -> sumbool
   end

  module WFactsExtra_fun =
   functor (E:DecidableTypeOrig) ->
   functor (W:sig
    type key = E.t
   ...
   functor (WFacts:sig
    ...
    val coq_In_dec : 'a1 W.t -> W.key -> sumbool
   end) ->
   struct
   end

  module type WFactsExtra_funSig =
   functor (E:DecidableTypeOrig) ->
   functor (W:sig
    type key = E.t
   ...
   sig
    ...
    module Raw :
     sig
      ...
      val mem : T.t -> 'a1 tree -> bool

      val find : T.t -> 'a1 tree -> 'a1 option
      ...
      val remove : T.t -> 'a1 tree -> 'a1 tree
      ...
      val split : T.t -> 'a1 tree -> 'a1 triple
      ...
      val equal_more :
        ('a1 -> 'a1 -> bool) -> T.t -> 'a1 -> ('a1 enumeration -> bool) ->
        'a1 enumeration -> bool
      ...
      module Proofs :
       sig
        ...
        val coq_R_mem_rect :
          T.t -> ('a1 tree -> __ -> 'a2) -> ('a1 tree -> 'a1 tree -> key ->
  ...
  module Decide =
   ...
   struct
    module Raw =
     struct
      (** val tree_rect :
          'a2 -> ('a1 M.Raw.tree -> 'a2 -> M.Raw.key -> 'a1 -> 'a1 M.Raw.tree
          -> 'a2 -> Int.Z_as_Int.t -> 'a2) -> 'a1 M.Raw.tree -> 'a2 **)

      let rec tree_rect f f0 = function
      | M.Raw.Leaf -> f
      | M.Raw.Node (t1, k, y, t2, t3) ->
      ...
      | M.Raw.Leaf -> f
      | M.Raw.Node (t1, k, y, t2, t3) ->
        f0 t1 (tree_caset_nodep f f0 t1) k y t2 (tree_caset_nodep f f0 t2) t3
      ...
      | M.Raw.Leaf -> f
      | M.Raw.Node (t1, k, y, t2, t3) ->
        f0 t1 (tree_rect_nodep f f0 t1) k y t2 (tree_rect_nodep f f0 t2) t3
      ...
      | M.Raw.Leaf -> f
      | M.Raw.Node (t1, k, y, t2, t3) ->
        f0 t1 (tree_rec_nodep f f0 t1) k y t2 (tree_rec_nodep f f0 t2) t3

      (** val lt_tree_dec : T.t -> 'a1 M.Raw.tree -> sumbool **)

      let rec lt_tree_dec x = function
      | M.Raw.Leaf -> Coq_left
      | M.Raw.Node (l, k, _, r, _) ->
        (match T.compare k x with
         | OrderedType.LT ->
      ...
      (** val gt_tree_dec : T.t -> 'a1 M.Raw.tree -> sumbool **)
      ...
      (** val bst_dec : 'a1 M.Raw.tree -> sumbool **)
        ...
        (match bst_dec l with
         | Coq_left ->
           (match bst_dec r with
            | Coq_left ->
              (match lt_tree_dec k l with
               | Coq_left -> gt_tree_dec k r
               | Coq_right -> Coq_right)
            | Coq_right -> Coq_right)
         | Coq_right -> Coq_right)
     end
