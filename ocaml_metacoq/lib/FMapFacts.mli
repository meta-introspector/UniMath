...
module WProperties_fun :
 ...
 sig
  ...
  val partition : (M.key -> 'a1 -> bool) -> 'a1 M.t -> ('a1 M.t, 'a1 M.t) prod
  ...
  val coq_Partition_In : 'a1 M.t -> 'a1 M.t -> 'a1 M.t -> M.key -> sumbool
  ...
  val partition_dom : (M.key -> bool) -> 'a1 M.t -> ('a1 M.t, 'a1 M.t) prod

  val partition_range : ('a1 -> bool) -> 'a1 M.t -> ('a1 M.t, 'a1 M.t) prod
 end
...
module OrdProperties :
 ...
 sig
  ...
  val elements_lt : (M.key, 'a1) prod -> 'a1 M.t -> (M.key, 'a1) prod list

  val elements_ge : (M.key, 'a1) prod -> 'a1 M.t -> (M.key, 'a1) prod list
