 ...
 sig
  module Raw :
   sig
    ...
    | R_bal_3 of t * X.t * t * Int.Z_as_Int.t * tree * X.t * tree
       * Int.Z_as_Int.t * tree * X.t * tree
    | R_bal_4 of t * X.t * t
    | R_bal_5 of t * X.t * t * Int.Z_as_Int.t * tree * X.t * tree
    | R_bal_6 of t * X.t * t * Int.Z_as_Int.t * tree * X.t * tree
    | R_bal_7 of t * X.t * t * Int.Z_as_Int.t * tree * X.t * tree
       * Int.Z_as_Int.t * tree * X.t * tree
    | R_bal_8 of t * X.t * t

    type coq_R_remove_min =
    | R_remove_min_0 of tree * elt * t
    | R_remove_min_1 of tree * elt * t * Int.Z_as_Int.t * tree * X.t * 
       tree * (t, elt) prod * coq_R_remove_min * t * elt

    type coq_R_merge =
    | R_merge_0 of tree * tree
    | R_merge_1 of tree * tree * Int.Z_as_Int.t * tree * X.t * tree
    | R_merge_2 of tree * tree * Int.Z_as_Int.t * tree * X.t * tree
       * Int.Z_as_Int.t * tree * X.t * tree * t * elt

    type coq_R_concat =
    | R_concat_0 of tree * tree
    | R_concat_1 of tree * tree * Int.Z_as_Int.t * tree * X.t * tree
    | R_concat_2 of tree * tree * Int.Z_as_Int.t * tree * X.t * tree
       * Int.Z_as_Int.t * tree * X.t * tree * t * elt

    type coq_R_inter =
    | R_inter_0 of tree * tree
    | R_inter_1 of tree * tree * Int.Z_as_Int.t * tree * X.t * tree
    | R_inter_2 of tree * tree * Int.Z_as_Int.t * tree * X.t * tree
       * Int.Z_as_Int.t * tree * X.t * tree * t * bool * t * tree
       * coq_R_inter * tree * coq_R_inter
    | R_inter_3 of tree * tree * Int.Z_as_Int.t * tree * X.t * tree
       * Int.Z_as_Int.t * tree * X.t * tree * t * bool * t * tree
       * coq_R_inter * tree * coq_R_inter
    ...
    | R_diff_2 of tree * tree * Int.Z_as_Int.t * tree * X.t * tree
       * Int.Z_as_Int.t * tree * X.t * tree * t * bool * t * tree
       * coq_R_diff * tree * coq_R_diff
    | R_diff_3 of tree * tree * Int.Z_as_Int.t * tree * X.t * tree
       * Int.Z_as_Int.t * tree * X.t * tree * t * bool * t * tree
       * coq_R_diff * tree * coq_R_diff
    ...
    | R_union_2 of tree * tree * Int.Z_as_Int.t * tree * X.t * tree
       * Int.Z_as_Int.t * tree * X.t * tree * t * bool * t * tree
